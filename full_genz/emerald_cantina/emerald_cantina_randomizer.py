...
def buildChars(name, generations, genCodesList):
    ...
    if genCSV == True:
        ...
        extraObjects = bpy.data.collections["Mask 1"].objects
        ...
        while v < generations:
            variant_to_csv("Mask " + str(v + 1)) #Variant
            win.progress_update(v)
            v += 1
...
class variantScrambler(bpy.types.Operator):
    ...
    bl_label = "Export: Mask Scrambler"
